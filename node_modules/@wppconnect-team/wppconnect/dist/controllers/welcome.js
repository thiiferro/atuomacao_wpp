...
function logUpdateAvailable(current, latest) {
    ...
    logger_1.defaultLogger.info("For more info visit: ".concat(chalk_1.default.underline('https://github.com/wppconnect-team/wppconnect/blob/master/README.md#update-checking'), "\n"));
}
