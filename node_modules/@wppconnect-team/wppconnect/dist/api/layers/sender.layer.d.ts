import type { FileMessageOptions, ListMessageOptions, LocationMessageOptions, SendMessageReturn, TextMessageOptions, PoolMessageOptions, ForwardMessagesOptions, AllMessageOptions } from '@wppconnect/wa-js/dist/chat';
...
export declare class SenderLayer extends ListenerLayer {
     ...
     * @param mentionedList
     */
    sendImageFromBase64(to: string, base64: string, filename: string, caption?: string, quotedMessageId?: string, isViewOnce?: boolean, mentionedList?: any): Promise<{
        ack: number;
        id: string;
        sendMsgResult: import("@wppconnect/wa-js/dist/whatsapp/enums").SendMsgResult;
    }>;
     ...
     */
    sendImageAsStickerGif(to: string, pathOrBase64: string, options?: AllMessageOptions): Promise<SendMessageReturn>;
    /**
     ...
     * @param to chatId '000000000000@c.us'
     */
    sendImageAsSticker(to: string, pathOrBase64: string, options?: AllMessageOptions): Promise<SendMessageReturn>;
    /**
